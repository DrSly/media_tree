...
static int dvbsky_set_voltage(struct dvb_frontend *fe,
...
static int dvbsky_set_voltage2(struct dvb_frontend *fe,
					fe_sec_voltage_t voltage)
{
	struct cx23885_tsport *port = fe->dvb->priv;
	struct cx23885_dev *dev = port->dev;
...
static const struct m88ds3103_config dvbsky_m88ds3103_config = {
	.i2c_addr = 0x68,
	.clock = 27000000,
	.i2c_wr_max = 33,
	.clock_out = 0,
...
static const struct m88ds3103_config dvbsky2_m88ds3103_config = {
	.i2c_addr = 0x68,
	.clock = 27000000,
	.i2c_wr_max = 33,
	.clock_out = 0,
...
static int dvb_register(struct cx23885_tsport *port)
{
	...
	case CX23885_BOARD_DVBSKY_S952: {
		...
		tveeprom_read(&dev->i2c_bus[0].i2c_client, eeprom,
				sizeof(eeprom));
		printk(KERN_INFO "DVBSky card port %d MAC address: %pM\n",
